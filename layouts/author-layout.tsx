      ...
      <div className="py-8">
        <div className="prose prose-lg max-w-none dark:prose-invert">
          <div>
            ...
            <p>
              I'm <strong>Rui Tao</strong>, currently pursuing my Master's degree in Electrical and
              Computer Engineering at the <strong>University of Washington</strong> (GPA: 3.97/4.0).
              I'm passionate about software development, with expertise in{' '}
              <strong>full-stack development</strong>, <strong>game development</strong>, and{' '}
              <strong>AI/ML applications</strong>.
            </p>
            <p>
              I have experience in building high-performance systems and modern web applications. My
              technical expertise spans across multiple domains, from developing game systems to
              implementing AI-driven solutions.
            </p>
            <p>
              I enjoy exploring new technologies and solving complex engineering challenges. Feel
              free to explore my projects and get in touch if you'd like to collaborate!
            </p>
          </div>
          <div>
          ...
          <div>
            <h2>Tech stack</h2>
            <p>I work with a wide range of technologies, including:</p>
              ...
              <li className="flex items-center gap-2">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="text-gray-600 dark:text-gray-400">
                    C/C++, Python, TS/JS, Go, Lua, Java, C#, Kotlin, CUDA
                  </span>
                </div>
              </li>
              <li className="flex items-center gap-2">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="text-gray-600 dark:text-gray-400">
                    React, Redux, Zustand, Next.js, Vue.js, Angular, Tailwind CSS, HTML/CSS
                  </span>
                </div>
              </li>
              <li className="flex items-center gap-2">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="text-gray-600 dark:text-gray-400">
                    Express, NestJS, Django, Flask, FastAPI, Spring Boot, Gin, gRPC
                  </span>
                </div>
              </li>
              <li className="flex items-center gap-2">
            ...
            <p>
              This portfolio site is built with modern technologies including{' '}
              <strong>Next.js</strong>, <strong>TypeScript</strong>, and{' '}
              <strong>Tailwind CSS</strong>, hosted on{' '}
          ...
          <div>
            <h2>Contact</h2>
            <p>
              Feel free to reach out to me for collaboration opportunities or just to chat about
              technology:
            </p>
            <ul>
              <li>
                Email: <a href={`mailto:${SITE_METADATA.email}`}>{SITE_METADATA.email}</a>
              </li>
